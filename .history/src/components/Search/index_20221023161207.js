...
class Search extends Component { 
	...
	handleChange(e) {
		...
		this.setState({ fromcur: e.target.value, tocur: e.target.value});
		this.props.updateAppState({fromcur:e.target.value, tocur: e.target.value})
	  }
	...
	render() {
		...
		return (
			<section className="jumbotron">
				...
				<div className="select-container">
					<select value={this.state.tocur} onChange={this.handleChange}>
